...
- Evn脚本跟随 WoChen5770 仓库，删除了源码自带的 dae、luci-app-dae、daed、luci-app-daed，拉取第三方 luci-app-daed（三合一）来替换，删除了源码自带的 msd_lite，但保留源码自带的 mosdns、smartdns 插件（在 WoChen5770 仓库被删除）
