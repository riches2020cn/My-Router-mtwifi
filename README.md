...
- Evn脚本跟随 WoChen5770 仓库，拉取第三方 luci-app-daed（二合一插件）来替换“dae、luci-app-dae”和“daed、luci-app-daed”2个插件。拉取第三方来替换 msd_lite插件，若要编译源码自带的 msd_lite插件，请修改“scripts/diy-script.sh”文件，注释掉相关命令
